...
-- CreateIndex
CREATE INDEX "messages_messId_idx" ON "messages"("messId");
...
-- AddForeignKey
ALTER TABLE "messages" ADD CONSTRAINT "messages_messId_fkey" FOREIGN KEY ("messId") REFERENCES "mess"("id") ON DELETE CASCADE ON UPDATE CASCADE;
